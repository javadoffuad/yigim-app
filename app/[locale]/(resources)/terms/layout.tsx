...
import { I18N_METADATA, I18N_TERMS_CONDITION_PAGE } from "@/app/constants/i18n.constants";
import { getMetadataTitle } from "@/app/utils/metadata.utils";

export async function generateMetadata({params}: ILayoutProps) {
  const {locale} = await params;
  const t = await getTranslations({locale, namespace: I18N_TERMS_CONDITION_PAGE});
